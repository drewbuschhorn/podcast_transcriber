...
def create_script(final_file = 'output/real.txt', speakers = []):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
                    prog='PodcastSRTsToScript',
                    description='Reads SRT files generated by my_transcribe.py'+
                                ' in output/*.mp3.srt into a single text file for humans.',
                    epilog='Find in output/real.txt')
